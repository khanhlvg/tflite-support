...
// Defines C structure for Object Detection Results and associated helper methods.
...
// Bounding box and list of predicted classes (aka labels) for a detected object.
